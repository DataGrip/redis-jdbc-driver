...
class RedisJedisClient implements RedisClient {

    private final Jedis jedis;

    public RedisJedisClient(String url, Properties info) throws SQLException {
        try {
            RedisJedisURI uri = new RedisJedisURI(url, info);
    ...
    private Object execute(RedisSetDatabaseQuery query) {
