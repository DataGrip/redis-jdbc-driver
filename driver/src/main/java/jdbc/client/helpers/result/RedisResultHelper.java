...
public class RedisResultHelper {
    ...
    private static final Map<CompositeCommand, ResultParser> RESULT_PARSERS = new HashMap<>() {{
        ...
        // TODO: put(RedisCompositeCommand.create(Protocol.Command.HRANDFIELD), ???); - check last param: WITHVALUES
        ...
        // TODO: put(RedisCompositeCommand.create(Command.ZDIFF), ResultParserFactory.?);
        ...
        // TODO: put(RedisCompositeCommand.create(Command.ZINTER), ResultParserFactory.?);
        ...
        // TODO: put(RedisCompositeCommand.create(Command.ZPOPMAX), ResultParserFactory.?);
        // TODO: put(RedisCompositeCommand.create(Command.ZPOPMIN), ResultParserFactory.?);
        // TODO: put(RedisCompositeCommand.create(Command.ZRANDMEMBER), ResultParserFactory.?);
        // TODO: put(RedisCompositeCommand.create(Command.ZRANGE), ResultParserFactory.?);
        // TODO: put(RedisCompositeCommand.create(Command.ZRANGEBYSCORE), ResultParserFactory.?);
        ...
        // TODO: put(RedisCompositeCommand.create(Command.ZREVRANGE), ResultParserFactory.?);
        // TODO: put(RedisCompositeCommand.create(Command.ZREVRANGEBTSCORE), ResultParserFactory.?);
