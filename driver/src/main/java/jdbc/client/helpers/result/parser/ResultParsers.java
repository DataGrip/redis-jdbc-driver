...
public class ResultParsers {
    ...
    static {
        ...
        // CRP_MAP.put(RedisCommands.SYNC,                    ???);
        ...
        // CRP_MAP.put(RedisCommands.XSETID,                  ???);
